...
function PANEL:PerformLayout()
	...
	self.lblTeams:SetPos( self:GetWide() - 50*5 - self.lblTeams:GetWide()/2, self.PlayerFrame.y - self.lblPing:GetTall() - 3  )
